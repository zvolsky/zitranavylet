...
'ok, informujte mě o významných změnách na webu (samozřejmě ne častěji než po čtvrt roce a s možností odhlášení)': 'ok, informujte mě o významných změnách na webu (samozřejmě ne častěji než po čtvrt roce a s možností odhlášení)',
...
'Python': 'Python',
'přihlašovací jméno (přezdívka) uživatele': 'přihlašovací jméno (přezdívka) uživatele',
'Query:': 'Dotaz:',
